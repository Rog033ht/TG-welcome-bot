...
LOCALES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "HELP_COMMANDS": (
            ...
            "<code>/poll_publish</code> — Publish a smart poll's voting button to a chat\n"
            "<code>/poll_channel_list</code> — List common publish targets for smart polls\n"
    ...
    "ph": {
        ...
        "HELP_COMMANDS": (
            ...
            "<code>/poll_publish</code> — I-publish ang voting button ng smart poll sa chat\n"
            "<code>/poll_channel_list</code> — I-lista ang common publish targets para sa smart polls\n"
    ...
    "vi": {
        ...
        "HELP_COMMANDS": (
            ...
            "<code>/poll_publish</code> — Cong bo nut vote cua smart poll sa chat\n"
            "<code>/poll_channel_list</code> — Liet ke cac chat chung cho viec publish smart poll\n"
    ...
    "es": {
        ...
        "HELP_COMMANDS": (
            ...
            "<code>/poll_publish</code> — Publicar el botón de votación de la encuesta en un chat\n"
            "<code>/poll_channel_list</code> — Mostrar destinos comunes para publicar smart polls\n"
    ...
    "tr": {
        ...
        "HELP_COMMANDS": (
            ...
            "<code>/poll_publish</code> — Smart poll oy düğmesini chata yayınla\n"
            "<code>/poll_channel_list</code> — Smart poll yayın için sık hedefleri listele\n"
